...
exports.config = {
  ...
  cucumberOpts: {
    require: [
      '__tests__/e2e/config/helpers/after.scenario.js',
      '__tests__/e2e/config/helpers/report.hook.js',
      '__tests__/e2e/step_definitions/base.steps.js',
      '__tests__/e2e/step_definitions/home.steps.js',
      '__tests__/e2e/step_definitions/onboarding.steps.js',
    ],
    backtrace: false,
...
function getFeatureFiles() {
  if (argv.feature) {
    return argv.feature.split(',')
      .map(feature => `${process.cwd()}/__tests__/e2e/**/${feature}.feature`);
  }

  return [`${process.cwd()}/__tests__/e2e/**/*.feature`];
}
